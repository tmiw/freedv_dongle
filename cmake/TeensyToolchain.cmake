...
set(TEENSY_OPTIONS "-DF_CPU=600000000 -DUSB_DUAL_SERIAL -DLAYOUT_US_ENGLISH -D__${MCU}__ -DARDUINO=10813 -DTEENSYDUINO=154 -D${MCU_DEF}")
...
set(CMAKE_C_FLAGS_INIT "-Wall -g -O2 ${TEENSY_CPUOPTIONS} -MMD ${TEENSY_OPTIONS} -I${TEENSY_CORE_DIR} -ffunction-sections -fdata-sections" CACHE STRING "Required compiler init flags")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -std=gnu++14 -felide-constructors -fno-exceptions -fpermissive -fno-rtti -Wno-error=narrowing" CACHE STRING "Required compiler init flags")
